<script>
import imgLogo from "@/assets/logoG1.png"; 
...
export default {
  ...
  methods: {
    login() {
      ...
      if (this.usuario === 'MtH' && this.password === '123') {
...
.logo {
   margin-bottom: 20px; /* Espaço entre logo e formulário */
}
.login-form {
   display: flex;
   flex-direction: column;
...
input {
   margin: 10px; /* Espaço entre inputs */
}
button {
